...
namespace ElectriStore_BaseProject.Services.Users
{
    public class UserService : IUserService
    {
        ...
        {
            var email = await _userRepository.GetUserByEmailAsync(registerRequest.Email ?? "");
            var phone = await _userRepository.GetUserByPhoneNumberAsync(registerRequest.PhoneNumber ?? "");
            ...
            bool isSaved = await _userRepository.SaveUser(newUser);
            if (!isSaved)
            {
